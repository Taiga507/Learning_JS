...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResourse)('https://taiga-d.ru/db2.json') //menu
  .then(data => {
    data.forEach(_ref => {
      let {
        img,
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('https://taiga-d.ru/db.json', json) //requests
      .then(data => {
        console.log(data);
  ...
  fetch('https://taiga-d.ru/db2.json') //menu
  .then(data => data.json());
...
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal */ "./src/js/modules/modal.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modalTimerId), 50000); // открытие модального окна через определенный промежуток времени
  ...
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2024-01-01');
});
}();
/******/ })()
;
